...
private:
  ...
  void updateNodes(TreeNode* node); // defined to update the height of the nodes after insert or delete accordingly
  void deleteNode(TreeNode* node); // to delete the node given the node itself
public:
  // Constructors
